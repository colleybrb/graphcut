...
from graphcut.media_prober import compute_file_hash
...
class Transcriber:
    ...
    def _ensure_model(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install 'graphcut[transcription]'"
            )
    ...
    def _extract_audio(self, file_path: Path) -> Path:
        ...
        tmp_dir = Path(tempfile.mkdtemp(prefix="graphcut_audio_"))
